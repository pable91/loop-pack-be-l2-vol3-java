...
class CouponTemplateTest {
    ...
    class Create {
        ...
        void success_create_coupon_template() {
            CouponTemplate template = CouponTemplate.create(DEFAULT_NAME, DEFAULT_DISCOUNT_TYPE, DEFAULT_MIN_ORDER_AMOUNT, DEFAULT_EXPIRED_AT);
        ...
        void fail_when_name_is_blank(String name) {
            assertCoreException(
                () -> CouponTemplate.create(name, DEFAULT_DISCOUNT_TYPE, DEFAULT_MIN_ORDER_AMOUNT, DEFAULT_EXPIRED_AT),
        ...
        void fail_when_discount_type_is_null() {
            assertCoreException(
                () -> CouponTemplate.create(DEFAULT_NAME, null, DEFAULT_MIN_ORDER_AMOUNT, DEFAULT_EXPIRED_AT),
        ...
        void fail_when_invalid_min_order_amount(Integer minOrderAmount) {
            assertCoreException(
                () -> CouponTemplate.create(DEFAULT_NAME, DEFAULT_DISCOUNT_TYPE, minOrderAmount, DEFAULT_EXPIRED_AT),
        ...
        void fail_when_expired_at_is_null() {
            assertCoreException(
                () -> CouponTemplate.create(DEFAULT_NAME, DEFAULT_DISCOUNT_TYPE, DEFAULT_MIN_ORDER_AMOUNT, null),
        ...
        void fail_when_expired_at_is_past() {
            ...
            assertCoreException(
                () -> CouponTemplate.create(DEFAULT_NAME, DEFAULT_DISCOUNT_TYPE, DEFAULT_MIN_ORDER_AMOUNT, pastExpiredAt),
